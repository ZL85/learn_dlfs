...
class MultiLayerNet:
    ...
    Parameters
    ----------
    input_size : 输入尺寸（对于MNIST数据集为784）
    hidden_size_list : 隐藏层中神经元数量的列表（e.g. [100, 100, 100]）
    output_size : 输出尺寸（对于MNIST数据集为10）
    activation : 'relu' or 'sigmoid'
    weight_init_std : 指定权重的标准差（e.g. 0.01）
        如果指定了 'relu' 或 'he'，则设置为 "He初始化"
        如果指定了 'sigmoid' 或 'xavier'，则设置为 "Xavier初始化"
    weight_decay_lambda : Weight Decay权重衰减（L2范数）的强度
    """
